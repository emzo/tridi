...
var Tridi = /** @class */ (function () {
    ...
    Tridi.prototype.setElementName = function () {
        ...
        return "unnamedTridi-".concat(Math.floor(Math.random() * 90000) + 10000);
    };
    ...
    Tridi.prototype.getElem = function (cssClass) {
        if (typeof this.element === 'string') {
            return cssClass
                ? (document.querySelector("".concat(this.element, " ").concat(cssClass)))
    ...
    Tridi.prototype.imgs = function () {
        ...
        if (this.images === 'numbered') {
            ...
            function (_a, index) {
                return "".concat(_this.location, "/").concat(index + 1, ".").concat(_this.format.toLowerCase());
            }));
        }
        return this.images;
    };
    Tridi.prototype.generateViewer = function () {
        this.viewer().className
            += ' tridi-viewer'
                + " tridi-".concat(this.elementName, "-viewer")
                + " tridi-draggable-".concat(this.draggable)
                + " tridi-touch-".concat(this.touch)
                + " tridi-mousewheel-".concat(this.mousewheel)
                + " tridi-hintOnStartup-".concat(this.hintOnStartup)
                + " tridi-lazy-".concat(this.lazy);
        this.trigger('onViewerGenerate');
    };
    Tridi.prototype.generateLoadingScreen = function () {
        var loadingScreen = document.createElement('div');
        loadingScreen.className += "tridi-loading tridi-".concat(this.elementName, "-loading");
        loadingScreen.style.display = 'none';
        var loadingSpinner = document.createElement('div');
        loadingSpinner.className += "tridi-spinner tridi-".concat(this.elementName, "-spinner");
    ...
    Tridi.prototype.displayHintOnStartup = function (callback) {
        ...
        if (this.hintOnStartup) {
            var hintOverlayClassName_1 = "tridi-".concat(this.elementName, "-hint-overlay");
            var hintOverlay = document.createElement('div');
            hintOverlay.className += "tridi-hint-overlay ".concat(hintOverlayClassName_1);
            hintOverlay.tabIndex = 0;
            var hintClassName_1 = "tridi-".concat(this.elementName, "-hint");
            var hint = document.createElement('div');
            hint.className += "tridi-hint ".concat(hintClassName_1);
            if (this.hintText) {
                hint.innerHTML = "<span class=\"tridi-hint-text tridi-".concat(this.elementName, "-hint-text\">").concat(this.hintText, "</span>");
            }
    ...
    Tridi.prototype.stashImage = function (stash, imageSrc, index, callback) {
        ...
        img.className += "tridi-image tridi-image-".concat(index + 1);
        img.src = imageSrc;
    ...
    Tridi.prototype.generateViewerImage = function () {
        ...
        viewerImage.className += "tridi-viewer-image tridi-".concat(this.elementName, "-viewer-image");
        viewerImage.setAttribute('draggable', 'false');
        viewerImage.setAttribute('alt', '');
        viewerImage.src = this.image(1);
        viewer.innerHTML = "".concat(viewerImage.outerHTML).concat(viewer.innerHTML);
    };
